...
<table>
  ...
  <tr class="even">
    ...
    <td><input name="long" type="text" size="50" value="<?= $r->st_longitude ?>" /> /
      <input name="lat" type="text" size="50" value="<?= $r->st_latitude ?>" />
  ...
  <tr valign="top" class="odd">
    <td>Alamat Site</td>
    <td><input name="adr" type="text" size="50" value="<?= $r->st_address ?>" />
      <div class="keterangan">* Diisi jika perlu</div>
    </td>
  </tr>
</table>